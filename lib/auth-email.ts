    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;background-color:#020202;">
      <tr>
        <td align="center" bgcolor="#020202">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#050505" style="max-width:600px;margin:0 auto;border-collapse:collapse;border:1px solid #1f1f1f;background-color:#050505;">
            <!-- 品牌头部 -->
            <tr>
              <td bgcolor="#050505" style="padding:18px 24px;border-bottom:1px solid #171717;">
            ...
            <!-- 标题区 -->
            <tr>
              <td bgcolor="#050505" style="padding:32px 28px 20px;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td style="border:1px solid #2a2a2a;background-color:#151515;padding:8px 14px;font-size:12px;color:#b8b8b8;">
                      <span style="display:inline-block;height:8px;width:8px;border-radius:50%;background:#34d399;margin-right:8px;vertical-align:middle;"></span>
                      <span style="vertical-align:middle;">登录后继续当前流程</span>
                    </td>
                  </tr>
                </table>
                <h1 style="margin:24px 0 0;font-size:32px;line-height:1.12;letter-spacing:-0.03em;font-weight:800;color:#ffffff;">
                  登录集盒<br />
                  <span style="color:#6f6f6f;">继续你的作品集整理</span>
                </h1>
                <p style="margin:20px 0 0;font-size:15px;line-height:1.85;color:#b8b8b8;">
                  点击下方按钮即可安全登录 <strong style="color:#ffffff;font-weight:600;">${host}</strong>，并返回你刚才的评分、项目或支付流程继续操作。
                </p>
                <p style="margin:12px 0 0;font-size:13px;line-height:1.8;color:#7c7c7c;">
            ...
            <!-- 操作区 -->
            <tr>
              <td bgcolor="#050505" style="padding:0 28px 32px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #1f1f1f;background-color:#0a0a0a;">
                  <tr>
                    <td style="padding:28px 24px 20px;">
                      <a href="${url}" target="_blank" rel="noreferrer" style="display:inline-block;background:#ffffff;color:#000000;text-decoration:none;font-size:14px;font-weight:700;padding:14px 22px;">打开登录链接 →</a>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:0 24px 20px;">
                      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #1d1d1d;background-color:#181818;">
                        <tr>
                          <td style="padding:14px 16px;font-size:12px;line-height:1.9;color:#9b9b9b;">
                  ...
                  <tr>
                    <td style="padding:0 24px 8px;font-size:12px;line-height:1.9;color:#7c7c7c;">
                      如果按钮无法打开，可以复制这条备用链接到浏览器地址栏：
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:0 24px 20px;">
                      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #1d1d1d;background-color:#111111;">
                        <tr>
                          <td style="padding:14px 16px;word-break:break-all;">
                  ...
                  <tr>
                    <td style="padding:0 24px 24px;border-top:1px solid #1d1d1d;">
                      <p style="margin:20px 0 0;font-size:12px;line-height:1.8;color:#6d6d6d;">如果这不是你发起的登录请求，可以直接忽略这封邮件。</p>
                    </td>
                  </tr>
                </table>
              </td>
